...
module.exports = {
    info: {
        ...
        usage: "[time[s/m/h]] [max_winners] [price]",
    ...
    if(!args[0].endsWith("s")&&!args[0].endsWith("h")&&!args[0].endsWith("d")&&!args[0].endsWith("m")) return message.channel.send(`**How long does the giveaway need to be? Eg. $!giveaway 10s/m/h/d**`)
