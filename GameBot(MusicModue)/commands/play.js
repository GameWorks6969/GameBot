...
module.exports = {
    ...
    run: async function (client, message, args) {
        ...
        const play = async (song) => {
            ...
            if (!song) {
                sendError(
                    "Leaving the voice channel because I think there are no songs in the queue. If you like the bot stay 24/7 in voice channel pls contact or DM me (GameWorksYT!) asking to remove it! If i get MORE than 10 request I will remove!\n\n",
                    message.channel
                );
